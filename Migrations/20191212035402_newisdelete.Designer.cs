...
namespace project.Migrations
{
    ...
    [Migration("20191212035402_newisdelete")]
    partial class newisdelete
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("project.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("project.Models.CourseInstructor", b =>
                {
                    ...
                    b.HasOne("project.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("project.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("project.Models.Person", "Student")
                        .WithMany("Enrollment")
